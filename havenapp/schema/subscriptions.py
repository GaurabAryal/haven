...
class OnNewChatMessage(channels_graphql_ws.Subscription):
    ...
    def publish(self, info, chatroom=None):
        ...
        print ("I subscripted to this group!" + new_msg_chatroom)
...
class OnNewTypingMessage(channels_graphql_ws.Subscription):
    """Subscription triggers on a new chat message."""
    ...
    @classmethod
    def new_typing_message(cls, chatroom, author):
        """Auxiliary function to send subscription notifications.
        ...
        cls.broadcast(
            group=chatroom,
            payload={"chatroom": chatroom, "author": author},
        )
...
class Subscription(graphene.ObjectType):
    ...
    on_new_typing_message = OnNewTypingMessage.Field()
